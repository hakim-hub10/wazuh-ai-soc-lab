...
- Rule-based detection triggered after multiple failed login attempts (~30 seconds).
- AI-based detection identified anomalous behavior significantly faster (~10 seconds) based on event volume and deviation (z-score).

- AI improved detection speed by approximately 40–60% compared to traditional rule-based detection.
